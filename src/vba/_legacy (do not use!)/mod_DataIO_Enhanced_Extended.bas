Attribute VB_Name = "mod_DataIO_Enhanced_Extended"
Option Explicit

' ==========================================================================
' Module      : mod_DataIO_Enhanced_Extended
' Author      : Cline (AI Assistant)
' Date        : May 7, 2025
' Purpose     : Extended version of mod_DataIO_Enhanced with enhanced diagnostics
'               to help troubleshoot any future Power Query refresh issues.
'               This version adds detailed connection state logging and diagnostics.
'
' Implementation Notes:
' This module extends mod_DataIO_Enhanced with comprehensive diagnostics for
' tracking the state of WorkbookConnection objects just before refresh attempts.
' These diagnostics can help identify the root cause of refresh failures.
'
' Usage:
' 1. Replace mod_DataIO_Enhanced with this module
' 2. Replace all references to mod_DataIO_Enhanced.RefreshPowerQuery
'    with mod_DataIO_Enhanced_Extended.RefreshPowerQuery
'
...
Public Function RefreshPowerQuery(targetTable As ListObject) As Boolean
    ...
    Application.OnTime mRefreshTimer, "'" & ThisWorkbook.Name & "'!mod_DataIO_Enhanced_Extended.ExecuteTimerRefresh"
...
Public Function CancelRefresh() As Boolean
    ...
    If mRefreshTimer <> 0 Then
        Application.OnTime mRefreshTimer, "'" & ThisWorkbook.Name & "'!mod_DataIO_Enhanced_Extended.ExecuteTimerRefresh", , False
    End If
